      ...
      <form @submit.prevent="login">
         <div class="form-group">
            <div class="input-group">
               ...
               <input class="form-control" name="email" v-model="username" type="email" placeholder="Email Address">
            </div>
            <div class="error_fild" v-if="errors.email">{{ errors.email[0] }}</div>
         </div>
         <div class="form-group password-field">
            <div class="input-group">
               ...
               <input class="form-control" name="password" v-model="password" type="password" placeholder="Password">
            ...
            <div class="error_fild" v-if="errors.password">{{ errors.password[0] }}</div>
         </div>
         ...
         <div>
            <button id="login_button" class="btn btn-primary btn-block" v-bind:class="{ disabled: loading }">
               <span v-if="loading"><i class="fas fa-circle-notch fa-spin"></i> Loading</span>
               <span v-else>Login</span>
            </button>
            <span v-if="wrongCredantila" id="wrong_info">{{wrongCredantila}}</span>
         </div>
         <div class="mt-10">
          ...
          login(){
             ...
             .catch(error =>{
                ...
                if(error.response.status == 401){
                  ...
                  this.username = null,
                  this.password = null,
                   this.wrongCredantila = error.response.data
                }
             })
          }
      }
