        ...
        <form @submit.prevent="registration">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" v-model="name" name="username" type="username" placeholder="Username">

                </div>
                <p id="error_message" v-if="errors.name">{{errors.name[0]}}</p>
            </div>
            ...
            <div class="form-group">
                ...
                <p id="error_message" v-if="errors.email">{{errors.email[0]}}</p>
            </div>
            ...
            <div class="form-group password-field">
                ...
                <p id="error_message" v-if="errors.password">{{errors.password[0]}}</p>
            </div>


            <div>
                <button id="register_button" class="btn btn-primary btn-block" v-bind:class="{ disabled: loading }">
            ...
            registration(){
                ...
                .then(response =>{
                    self.$Message.success({
                        background: true,
                        content: 'Hey you have succesfuly register . Now login'
                    });
